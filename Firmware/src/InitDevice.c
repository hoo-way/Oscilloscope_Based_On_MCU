...
TIMER16_3_enter_DefaultMode_from_RESET(void)
{
   ...
   */
  TMR3CN0 |= TMR3CN0_T3XCLK__LFOSC_DIV_8;  // 80KHz/8
  // [TMR3CN0 - Timer 3 Control]$
  ...
  //added by vihu raload add = 65536 - RLH:RLL, default 2500. so frenquence is 80KHZ/8/2500 = 4 Hz
...
//  TMR3RLL = (0x3C << TMR3RLL_TMR3RLL__SHIFT);
  TMR3RLL = (0xF6 << TMR3RLL_TMR3RLL__SHIFT);
  // [TMR3RLL - Timer 3 Reload Low Byte]$
