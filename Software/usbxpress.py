...
class USBXpressLib(object):
    ...
    def __init__(self):
        ...
        if os.name == 'nt':
            # print "dll:", __file__
            self._dll = ctypes.WinDLL(os.path.join(os.path.dirname(__file__), "SiUSBXp.dll"))
            # self._dll = ctypes.WinDLL("C:/Users/vihu.SILABS_AD/PycharmProjects/Oscilloscope_EFM8UB1/SiUSBXp.dll")
        else:
...
class USBXpressDevice(USBXpressLib):
    ...
    def read(self, num_bytes = 4096, o = None):
        ...
        return num_bytes_returned.value,bytes(read_buf)
